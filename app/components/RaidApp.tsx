...
function WipefestCalibrationWizard({ disabled, onBossIdentified, onSaved }: { disabled: boolean; onBossIdentified: (bossId: string) => void; onSaved: (rules: MechanicRule[]) => void }) {
